...
if (mysqli_num_rows($result) > 0) {
    ...
    ?>
		...
		<button type="submit" name="reject" id="passed" class="btn btn-sm btn-danger pull-right btn-space"> Reject</button>
		<button type="submit" name="pending" id="passed" class="btn btn-sm btn-warning pull-right btn-space"> Pending</button>
		<button type="submit" name="approve" id="passed" class="btn btn-sm btn-success pull-right btn-space"> Approve</button>
